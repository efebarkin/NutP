  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 text-white py-16 relative overflow-hidden">
      ...
      <div class="container mx-auto px-4 relative z-10">
        ...
        <p class="text-lg md:text-xl opacity-90 animate-slide-in">Sağlıklı beslenme yolculuğunuzda size rehberlik ediyoruz</p>
      </div>
    </div>

    <div class="container mx-auto px-4 py-8">
      <!-- Arama ve Filtreleme -->
      <div class="bg-white rounded-xl shadow-lg p-6 mb-8 transform hover:scale-[1.01] transition-all duration-300 border-t-4 border-green-500">
          ...
          <div class="flex-1">
            <div class="relative">
              <input
                ...
                @input="handleSearch"
              />
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 absolute left-3 top-3.5 animate-pulse-subtle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-all duration-300 transform hover:scale-105 hover:bg-green-50 border border-gray-100 hover:border-green-200 stat-card">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-all duration-300 transform hover:scale-105 hover:bg-green-50 border border-gray-100 hover:border-green-200 stat-card delay-100">
          <div class="flex items-center space-x-4">
            <div class="p-3 bg-green-100 rounded-lg animate-pulse-slow">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-all duration-300 transform hover:scale-105 hover:bg-green-50 border border-gray-100 hover:border-green-200 stat-card delay-200">
          <div class="flex items-center space-x-4">
            <div class="p-3 bg-green-100 rounded-lg animate-pulse-slow">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        ...
        >
          <div class="p-6 relative">
            <div class="absolute top-0 right-0 w-24 h-24 -mr-12 -mt-12 bg-green-100 rounded-full opacity-50 group-hover:scale-125 transition-all duration-500"></div>
            
            <div class="flex justify-between items-start mb-4 relative">
              <div>
                <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition-colors flex items-center space-x-2">
                  {{ food.name.tr }}
                  <span class="w-2 h-2 bg-green-500 rounded-full animate-ping-slow inline-block ml-2"></span>
                </h3>
                <p class="text-sm text-gray-600">{{ food.name.en }}</p>
              </div>
              <span class="px-3 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full group-hover:bg-green-200 transition-colors">
                {{ food.category }}
              </span>
            </div>

            <div class="space-y-3 relative">
              <div class="flex items-center justify-between py-2 border-b border-gray-100 hover:border-green-100 transition-colors">
                <span class="text-gray-600 flex items-center">
                  <span class="w-3 h-3 rounded-full bg-red-400 mr-2 opacity-75"></span>
                  Kalori
                </span>
                <span class="font-medium">{{ food.nutrients.energy.value }} {{ food.nutrients.energy.unit }}</span>
              </div>
              <div class="flex items-center justify-between py-2 border-b border-gray-100 hover:border-green-100 transition-colors">
                <span class="text-gray-600 flex items-center">
                ...
                <span class="font-medium">{{ food.nutrients.protein.value }} {{ food.nutrients.protein.unit }}</span>
              </div>
              <div class="flex items-center justify-between py-2 border-b border-gray-100 hover:border-green-100 transition-colors">
                <span class="text-gray-600 flex items-center">
                ...
                <span class="font-medium">{{ food.nutrients.carbohydrate.value }} {{ food.nutrients.carbohydrate.unit }}</span>
              </div>
              <div class="flex items-center justify-between py-2">
                ...
                <span class="font-medium">{{ food.nutrients.fat.value }} {{ food.nutrients.fat.unit }}</span>
              </div>
            </div>
      ...
      >
        ...
        >
          <div class="flex justify-between items-start mb-6">
            <div class="animate-fade-in">
              <h2 class="text-2xl font-bold text-gray-900 flex items-center">
                ...
                <span class="ml-2 px-3 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full badge">
          ...
          <div class="space-y-8 animate-slide-in">
            <!-- Temel Bilgiler -->
            <div class="bg-gray-50 rounded-xl p-6 hover:shadow-md transition-all duration-300 hover:bg-gray-100">
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex items-center space-x-2 p-2 hover:bg-white rounded-lg transition-colors">
                  ...
                  <span class="font-semibold text-green-700">{{ selectedFood.portions[0]?.weight }}g</span>
                </div>
              </div>
            </div>
            ...
            <div class="animate-fade-in" style="animation-delay: 100ms">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-white rounded-xl shadow-sm p-4 hover:shadow-md transition-all duration-300 hover:bg-red-50">
                  <div class="flex items-center mb-2">
                    <span class="nutrient-dot dot-energy animate-pulse-slow"></span>
                    <span class="font-medium text-gray-700">Enerji</span>
                  </div>
                  <div class="text-xl font-bold text-gray-900">{{ selectedFood.nutrients.energy.value }} <span class="text-sm font-normal text-gray-600">{{ selectedFood.nutrients.energy.unit }}</span></div>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-4 hover:shadow-md transition-all duration-300 hover:bg-blue-50">
                  <div class="flex items-center mb-2">
                    <span class="nutrient-dot dot-protein animate-pulse-slow"></span>
                    <span class="font-medium text-gray-700">Protein</span>
                  </div>
                  <div class="text-xl font-bold text-gray-900">{{ selectedFood.nutrients.protein.value }} <span class="text-sm font-normal text-gray-600">{{ selectedFood.nutrients.protein.unit }}</span></div>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-4 hover:shadow-md transition-all duration-300 hover:bg-yellow-50">
                  <div class="flex items-center mb-2">
                    <span class="nutrient-dot dot-carbs animate-pulse-slow"></span>
                    <span class="font-medium text-gray-700">Karbonhidrat</span>
                  </div>
                  <div class="text-xl font-bold text-gray-900">{{ selectedFood.nutrients.carbohydrate.value }} <span class="text-sm font-normal text-gray-600">{{ selectedFood.nutrients.carbohydrate.unit }}</span></div>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-4 hover:shadow-md transition-all duration-300 hover:bg-purple-50">
                  <div class="flex items-center mb-2">
                    <span class="nutrient-dot dot-fat animate-pulse-slow"></span>
                    <span class="font-medium text-gray-700">Yağ</span>
                  </div>
                  <div class="text-xl font-bold text-gray-900">{{ selectedFood.nutrients.fat.value }} <span class="text-sm font-normal text-gray-600">{{ selectedFood.nutrients.fat.unit }}</span></div>
                </div>
              </div>
            </div>

            <!-- Diğer bölümler -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 animate-fade-in" style="animation-delay: 200ms">
              <!-- Yağ Profili -->
              <div>
                <h3 class="text-lg font-semibold mb-4 text-green-700 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="space-y-3">
                  <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span class="font-medium">{{ selectedFood.nutrients.saturatedFat?.value || 0 }}g</span>
                  </div>
                  <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    <span class="text-gray-600">Tekli Doymamış</span>
                    <span class="font-medium">{{ selectedFood.nutrients.monounsaturatedFat?.value || 0 }}g</span>
                  </div>
                  <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    <span class="text-gray-600">Çoklu Doymamış</span>
                    <span class="font-medium">{{ selectedFood.nutrients.polyunsaturatedFat?.value || 0 }}g</span>
                  </div>
                  <div class="flex justify-between items-center py-2">
                    <span class="text-gray-600">Kolesterol</span>
                    <span class="font-medium">{{ selectedFood.nutrients.cholesterol?.value || 0 }}mg</span>
                  </div>
                </div>
              </div>
