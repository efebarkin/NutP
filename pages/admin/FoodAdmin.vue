            ...
            <tr v-if="loading">
              ...
              >
                <div class="flex justify-center">
                  <div
                    class="animate-spin rounded-full h-10 w-10 border-b-2 border-green-500"
                  ></div>
                </div>
              ...
              >
                ...
                >
                  <div class="bg-gray-100 rounded-full p-3">
                    <i
                      class="fas fa-search text-gray-400 text-xl"
                    ></i>
                  </div>
                  <p class="mt-2 text-sm text-gray-500">
                    {{
            ...
            >
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div
                    class="h-10 w-10 flex-shrink-0 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden"
                  >
                    ...
                    <i
                      v-else
                      class="fas fa-utensils text-gray-500"
                    ></i>
                  </div>
                  <div class="ml-4">
                    <div
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <button
                  class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-50 text-sm font-medium text-green-600"
                >
                  2
                </button>
                <button
              ...
              >
                ...
                <div class="col-span-1 md:col-span-2">
                  ...
                  <div class="flex items-start space-x-4">
                    ...
                    <div
                      v-if="
                        editingFood.photoUrl || previewImage
                      "
                    ...
                    <div
                      v-else
                      class="w-24 h-24 border rounded-md flex items-center justify-center bg-gray-100"
                    >
                      <i
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
              ...
              >
                ...
                <div>
                  ...
                  <input
                    v-model.number="
                      editingFood.nutrients.energy.value
                    "
                    type="number"
                    min="0"
                    step="0.01"
                ...
                <div>
                  ...
                  <input
                    v-model.number="
                      editingFood.nutrients.protein.value
                    "
                    type="number"
                    min="0"
                    step="0.01"
                ...
                <div>
                  ...
                  <input
                    v-model.number="
                      editingFood.nutrients.fat.value
                    "
                    type="number"
                    min="0"
                    step="0.01"
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-gray-700 mb-1"
                    >Karbonhidrat (g)</label
                  >
                  <input
                    v-model.number="
                      editingFood.nutrients.carbohydrate
                        .value
                    "
                    type="number"
                    min="0"
                ...
                <div>
                  ...
                  <input
                    v-model.number="
                      editingFood.nutrients.fiber.value
                    "
                    type="number"
                    min="0"
                    step="0.01"
                ...
                <div>
                  ...
                  <input
                    v-model.number="
                      editingFood.nutrients.sugar.value
                    "
                    type="number"
                    min="0"
                    step="0.01"
                ...
                <div class="mb-4">
                  ...
                  >
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.saturatedFat
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.transFat
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.omega3.value
                        "
                        type="number"
                        min="0"
                        step="0.01"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.omega6.value
                        "
                        type="number"
                        min="0"
                        step="0.01"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.cholesterol
                            .value
                        "
                        type="number"
                        min="0"
                ...
                <div class="mb-4">
                  ...
                  >
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.minerals
                            .calcium.value
                        "
                        type="number"
                        min="0"
                ...
                <div class="mb-4">
                  ...
                  >
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.a
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.c
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.d
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.e
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.k
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      <label
                        class="block text-sm font-medium text-gray-700 mb-1"
                        >Vitamin B1 (Tiamin) (mg)</label
                      >
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b1
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      <label
                        class="block text-sm font-medium text-gray-700 mb-1"
                        >Vitamin B2 (Riboflavin) (mg)</label
                      >
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b2
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      <label
                        class="block text-sm font-medium text-gray-700 mb-1"
                        >Vitamin B3 (Niasin) (mg)</label
                      >
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b3
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b5
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b6
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      <label
                        class="block text-sm font-medium text-gray-700 mb-1"
                        >Vitamin B7 (Biotin) (μg)</label
                      >
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b7
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      <label
                        class="block text-sm font-medium text-gray-700 mb-1"
                        >Vitamin B9 (Folat) (μg)</label
                      >
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b9
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      <label
                        class="block text-sm font-medium text-gray-700 mb-1"
                        >Vitamin B12 (μg)</label
                      >
                      <input
                        v-model.number="
                          editingFood.nutrients.vitamins.b12
                            .value
                        "
                        type="number"
                        min="0"
                ...
                <div class="mb-4">
                  ...
                  >
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.aminoAcids
                            .tryptophan.value
                        "
                        type="number"
                        min="0"
                ...
                <div class="mb-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.others.water
                            .value
                        "
                        type="number"
                        min="0"
                    ...
                    <div>
                      ...
                      <input
                        v-model.number="
                          editingFood.nutrients.others.ash
                            .value
                        "
                        type="number"
                        min="0"
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
              ...
              >
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-gray-700 mb-1"
                    >Orijinal Kategori</label
                  >
                  <input
                    v-model="
                      editingFood.metadata.originalCategory
                    "
                    type="text"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                  />
                ...
                <div class="flex items-center">
                  <input
                    id="isVerified"
                    v-model="
                      editingFood.metadata.isVerified
                    "
                    type="checkbox"
...
async function fetchFoods(searchQuery = '') {
  ...
  try {
    ...
    if (data && data.foods) {
      ...
      console.warn(
        'API beklenmeyen format döndürdü:',
        data
      );
      foods.value = [];
    }
    ...
    showToast(
      'error',
      'Besinleri getirirken bir hata oluştu.'
    );
    foods.value = [];
  } finally {
    loading.value = false;
  ...
  try {
    ...
    if (data) {
      ...
      Object.keys(editingFood.nutrients).forEach(key => {
        ...
        if (nutrients[key]) {
          editingFood.nutrients[key].value =
            nutrients[key].value || 0;
          editingFood.nutrients[key].unit =
            nutrients[key].unit ||
            editingFood.nutrients[key].unit;
        } else {
      ...
      Object.keys(editingFood.nutrients.aminoAcids).forEach(
        key => {
          if (aminoAcids[key]) {
            editingFood.nutrients.aminoAcids[key].value =
              aminoAcids[key].value || 0;
            editingFood.nutrients.aminoAcids[key].unit =
              aminoAcids[key].unit ||
              editingFood.nutrients.aminoAcids[key].unit;
          }
        }
      ...
      Object.keys(editingFood.nutrients.minerals).forEach(
        key => {
          if (minerals[key]) {
            editingFood.nutrients.minerals[key].value =
              minerals[key].value || 0;
            editingFood.nutrients.minerals[key].unit =
              minerals[key].unit ||
              editingFood.nutrients.minerals[key].unit;
      ...
      Object.keys(editingFood.nutrients.vitamins).forEach(
        key => {
          if (vitamins[key]) {
            editingFood.nutrients.vitamins[key].value =
              vitamins[key].value || 0;
            editingFood.nutrients.vitamins[key].unit =
              vitamins[key].unit ||
              editingFood.nutrients.vitamins[key].unit;
          } else {
            ...
            if (mappedKey && nutrients[mappedKey]) {
              editingFood.nutrients.vitamins[key].value =
                nutrients[mappedKey].value || 0;
              editingFood.nutrients.vitamins[key].unit =
                nutrients[mappedKey].unit ||
                editingFood.nutrients.vitamins[key].unit;
            }
          }
        }
      ...
      Object.keys(editingFood.nutrients.others).forEach(
        key => {
          if (others[key]) {
            editingFood.nutrients.others[key].value =
              others[key].value || 0;
            editingFood.nutrients.others[key].unit =
              others[key].unit ||
              editingFood.nutrients.others[key].unit;
          } else if (nutrients[key]) {
      ...
      // Porsiyonlar
      editingFood.portions = Array.isArray(food.portions)
        ? [...food.portions]
        : [];
    ...
    console.error(
      'Besin detaylarını getirirken hata:',
      err
    );
    showToast(
      'error',
      'Besin detaylarını getirirken bir hata oluştu: ' +
        err.message
    );
    closeEditModal();
  } finally {
...
async function updateFood() {
  ...
  try {
    ...
    if (!response.ok) {
      throw new Error(
        `Güncelleme işlemi başarısız: ${response.status}`
      );
    }
    ...
    if (result.success) {
      ...
      showToast(
        'error',
        result.message || 'Güncelleme işlemi başarısız oldu'
      );
    }
  } catch (err) {
...
async function addFood() {
  ...
  try {
    ...
    if (!response.ok) {
      throw new Error(
        `Ekleme işlemi başarısız: ${response.status}`
      );
    }
    ...
    if (result.success) {
      ...
      showToast(
        'error',
        result.message || 'Ekleme işlemi başarısız oldu'
      );
    }
  } catch (err) {
...
async function uploadPhoto() {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        errorData.error || 'Fotoğraf yükleme hatası'
      );
    }
...
async function deleteFood(id) {
  try {
    ...
    if (result.success) {
      ...
      showToast(
        'error',
        result.message || 'Silme işlemi başarısız oldu.'
      );
    }
  } catch (err) {
